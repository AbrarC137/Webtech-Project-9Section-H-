					...
					<td colspan="3">
							...
							<table align="center">
								...
								<tr>
									...
									<td><input type="date" name="entrydate" id="entrydate" value="" placeholder="Entry date"></td>
								</tr>
								...
								<tr>
									<td>Discount</td>
									<td><input type="text" name="discount" id="discount" value="" placeholder="Discount"></td>
								</tr>
								
								<tr>
									<td>Status</td>
									<td><input type="text" name="status" id="status" value="" placeholder="Status"></td>
								</tr>
